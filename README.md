...
The OpenSearch 3.x release line currently declares support for OpenSearch `3.1.0`, `3.3.0`, `3.5.0`, and `3.6.0`. Build the plugin with the exact target version:
