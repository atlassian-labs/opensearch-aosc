...
/** Data body for {@link ClearClusterStateRequest}. */
@Value
@Jacksonized
@Builder
@AllArgsConstructor
...
public class ClearClusterStateBody implements JacksonWriteable, JacksonToXContentObject {
