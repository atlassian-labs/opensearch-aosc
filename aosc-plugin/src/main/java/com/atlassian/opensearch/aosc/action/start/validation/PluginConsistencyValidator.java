...
public final class PluginConsistencyValidator implements AsyncMigrationStartValidator {
    ...
    static void validatePluginOnAllNodes(AsyncClientHelper clientHelper, String pluginName, ActionListener<Void> listener) {
        NodesInfoRequest nodesInfoRequest = new NodesInfoRequest();
        nodesInfoRequest.clear().addMetric("plugins");
        clientHelper.executeNodesInfoAsync(nodesInfoRequest, ActionListener.wrap(response -> {
