...
public final class ValidationContext {
    ...
    public static ValidationContext of(
        ...
        return new ValidationContext(request, clusterState, sourceMeta, targetMeta, transformFactory, clusterSettings, clientHelper);
    }
    ...
    public AsyncClientHelper clientHelper() {
        return clientHelper;
    }
}
