...
/** Data body for {@link UpdateShardMigrationStatusRequest}. */
@Value
@Jacksonized
@Builder
@AllArgsConstructor
...
public class UpdateShardMigrationStatusBody implements JacksonWriteable, JacksonToXContentObject {
    ...
    ShardProgressDocument progress;
}
