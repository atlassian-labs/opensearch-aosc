...
public class BulkWriterFactory {
    ...
    public BulkWriterFactory(AsyncClientHelper clientHelper, ThreadPool threadPool, ClusterSettings clusterSettings) {
    ...
    public BulkWriter createBackfillWriter(AoscLogger logger) {
        ...
        return new ConcurrentBulkWriter(clientHelper, threadPool, controller, logger);
    }
