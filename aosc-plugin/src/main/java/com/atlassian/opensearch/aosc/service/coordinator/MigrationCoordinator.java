...
class MigrationCoordinator implements Closeable {
     ...
     * @param clientHelper    async client helper for index admin operations
    ...
    MigrationCoordinator(
        ...
        this.indexOperationUtils = new IndexOperationUtils(logger, Objects.requireNonNull(clientHelper, "clientHelper"));
        this.cutoverService = new CutoverService(logger.with(LC.PHASE, "cutover"), clientHelper, this.indexOperationUtils, migrationId);
