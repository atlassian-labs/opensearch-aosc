...
public class RetentionLeaseManager {
     ...
     * @param clientHelper the async client helper for executing lease actions
     ...
     */
    public RetentionLeaseManager(AoscLogger logger, AsyncClientHelper clientHelper, ShardId shardId, String migrationId) {
    ...
    public CompletableFuture<Void> acquire(long retainingSeqNo) {
        ...
        return clientHelper.executeAsync(RetentionLeaseActions.Add.INSTANCE, req).thenApply(r -> {
    ...
    public CompletableFuture<Void> renew(long retainingSeqNo) {
        ...
        return clientHelper.executeAsync(RetentionLeaseActions.Renew.INSTANCE, req).thenApply(r -> (Void) null).exceptionally(e -> {
    ...
    public CompletableFuture<Void> release() {
        ...
        return clientHelper.executeAsync(RetentionLeaseActions.Remove.INSTANCE, req).thenApply(r -> {
