...
public class IndexOperationUtils {
    ...
    public IndexOperationUtils(AoscLogger logger, AsyncClientHelper clientHelper) {
    ...
    public CompletableFuture<Void> disableRebalance(String index) {
        ...
        return clientHelper.executeUpdateSettingsAsync(req).thenApply(response -> null);
    }
    ...
    public CompletableFuture<Void> applyWriteBlock(String index) {
        return clientHelper.executeAddIndexBlockByName(index).thenApply(response -> null);
    }
    ...
    public CompletableFuture<Void> swapAlias(String sourceIndex, String targetIndex, String alias) {
        ...
        return clientHelper.executeAliasesAsync(req).thenApply(response -> null);
    }
    ...
    public CompletableFuture<Void> flushIndex(String index) {
        ...
        return clientHelper.executeFlushAsync(req).thenApply(response -> null);
    }
    ...
    public CompletableFuture<Void> applySettings(String index, Map<String, String> settings) {
        ...
        return clientHelper.executeUpdateSettingsAsync(req).thenApply(r -> null);
    }
    ...
    public CompletableFuture<Void> waitForGreen(String index, TimeValue timeout) {
        ...
        return clientHelper.executeClusterHealthAsync(req).thenAccept(response -> {
    ...
    public CompletableFuture<List<MatchedLease>> findAoscLeases(String[] indices) {
        ...
        return clientHelper.executeAsync(IndicesStatsAction.INSTANCE, statsRequest).thenApply(IndexOperationUtils::collectAoscLeases);
    }
    ...
    public CompletableFuture<CleanupLeasesResult.LeaseInfo> removeAoscLease(MatchedLease matched) {
        ...
        return clientHelper.executeAsync(RetentionLeaseActions.Remove.INSTANCE, req)
