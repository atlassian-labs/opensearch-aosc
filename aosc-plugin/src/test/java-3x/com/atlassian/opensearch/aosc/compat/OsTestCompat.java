...
/** OpenSearch 3.x test compat: ShardStats 7-param constructor. */
public final class OsTestCompat {
    ...
    public static ShardStats createShardStats(
        ...
        return new ShardStats(routing, path, stats, commit, seqNo, leaseStats, null);
    }

    public static ShardStats createShardStatsNoLeases(ShardRouting routing, ShardPath path, CommonStats stats) {
        return new ShardStats(routing, path, stats, null, null, null, null);
    }
}
