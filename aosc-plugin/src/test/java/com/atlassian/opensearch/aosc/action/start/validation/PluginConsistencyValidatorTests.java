...
public class PluginConsistencyValidatorTests extends OpenSearchTestCase {
    ...
    public void testEmptyNodesPasses() throws Exception {
        ...
        var admin = MockClientFactory.mockAdminClient();
        var cluster = MockClientFactory.mockClusterAdminClient();
        ...
        CompletableFuture<Void> f = new PluginConsistencyValidator().validate(ctx(AsyncClientHelper.wrap(client)));
