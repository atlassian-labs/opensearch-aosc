...
public class CutoverServiceTests extends OpenSearchTestCase {
    ...
    private MockClientFactory.Handle clientHandle;
    ...
    public void setUp() throws Exception {
        super.setUp();
        clientHandle = MockClientFactory.createHandle();

        mockIndexOps = mock(IndexOperationUtils.class);
        cutoverService = new CutoverService(AoscLogger.create(CutoverService.class), clientHandle.helper(), mockIndexOps, "test-migration");
    }
    ...
    private void mockRefreshSuccess() {
        doAnswer(invocation -> {
            ...
            return null;
        }).when(clientHandle.indicesAdmin()).refresh(any(RefreshRequest.class), any(ActionListener.class));
    }
    ...
    private void mockSearchDocCounts(String sourceIndex, long sourceCount, String targetIndex, long targetCount) {
        doAnswer(invocation -> {
            ...
            return null;
        }).when(clientHandle.client()).search(any(SearchRequest.class), any(ActionListener.class));
    }
}
